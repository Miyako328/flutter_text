...
class MicStreamController extends GetxController {
  ...
  RxString tempVoice = 'assets/images/voice/voice_volume_1.png'.obs;
  ...
  void _updateVoiceVolume(double voiceData) {
    ...
    if (voiceData > 0 && voiceData < 0.1) {
      tempVoice.value = 'assets/images/voice/voice_volume_2.png';
    } else if (voiceData > 0.2 && voiceData < 0.3) {
      tempVoice.value = 'assets/images/voice/voice_volume_3.png';
    } else if (voiceData > 0.3 && voiceData < 0.4) {
      tempVoice.value = 'assets/images/voice/voice_volume_4.png';
    } else if (voiceData > 0.4 && voiceData < 0.5) {
      tempVoice.value = 'assets/images/voice/voice_volume_5.png';
    } else if (voiceData > 0.5 && voiceData < 0.6) {
      tempVoice.value = 'assets/images/voice/voice_volume_6.png';
    } else if (voiceData > 0.6 && voiceData < 0.7) {
      tempVoice.value = 'assets/images/voice/voice_volume_7.png';
  ...
  void resetVoiceVolume() {
    tempVoice.value = 'assets/images/voice/voice_volume_1.png';
